...
namespace FoodyAPI.Controllers
{
    ...
    public class LoginController : ControllerBase
    {
        ...
        [Route("google-login")]
        [HttpPost]
        public async Task<ActionResult> TokenLogin(string tokenId)
        {
            ...
            var settings = new GoogleJsonWebSignature.ValidationSettings() { Audience = new List<string>() { Constants.Instance.GOOGLE_CLIENT_ID } };
